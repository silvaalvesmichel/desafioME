...
public class RegraStatusAprovado implements RegraStatus {
	...
	public RegraStatusAprovado(PedidoStatusDTO pedidoStatus, Double valorPedido, Integer quantidadeItensPedido,
			Integer pedido) {
	...
	public PedidoStatusRespostaDTO getStatus() {
		...
		if (pedidoStatus.getItensAprovados() == quantidadeItensPedido
				&& pedidoStatus.getValorAprovado().equals(valorPedido) && Util.isStatusAprovado(pedidoStatus)) {
